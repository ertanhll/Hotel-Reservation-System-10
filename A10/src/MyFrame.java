...
public class MyFrame extends JFrame {
	...
	public MyFrame() {
		...
		JButton displayReservationForCityButton = new JButton("Display Reservation for City");
		...
		displayReservationForCityButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (numOfReservations == 0) {
					textArea.append("There are no reservations yet. Please try again later.\n");
					return;
				}
	...
	private void createHotelReservationSystem() {
		...
		reservationMenuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Reservation reservationList = new Reservation(cityName, hotelName, reservationMonth,
